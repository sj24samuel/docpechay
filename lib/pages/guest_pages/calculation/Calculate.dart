...
class Calculate_guest extends StatefulWidget {
  // ignore: use_super_parameters
  const Calculate_guest({Key? key}) : super(key: key);

  @override
  State<Calculate_guest> createState() => _CalculateState();
}

class _CalculateState extends State<Calculate_guest> {
