...
import 'package:image_picker/image_picker.dart';
import 'package:firebase_storage/firebase_storage.dart';
import 'package:firebase_database/firebase_database.dart'; // ✅ RTDB import
...
class _CreateProfilePageState extends State<CreateProfilePage> {
  ...
  Future<void> saveUserInfo() async {
    ...
    try {
      ...
      // 🔥 Save to Firestore
      await FirebaseFirestore.instance.collection('user').doc('userinfo').set(userData);

      // ✅ Save to Realtime Database
      final DatabaseReference rtdbRef = FirebaseDatabase.instance.ref().child('users/$userId');
      await rtdbRef.set(userData);

      print("✅ Data saved to both Firestore and RTDB!");
